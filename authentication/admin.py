...
from authentication.forms import UserAdminCreationForm, UserAdminChangeForm
...
class UserAdmin(BaseUserAdmin):
    ...
    add_fieldsets = (
        (None, {"classes": ("wide",), "fields": ("email", "password1", "password2", "first_name",
                                                 "last_name", "is_active", "is_staff", "is_admin", "buyer", "employee", "non"), }, ),
    )
    ordering = ("email",)
    filter_horizontal = ()


admin.site.site_title = "custom Administrator pannel"
admin.site.index_title = "Administrator pannel | custom"
admin.site.site_header = "Administrator pannel Dashboard | custom"
