...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        # Most projects rely on TokenAuthentication, but your choice
...
# Not needed we will have custom Login & logout views depending with
...
ACCOUNT_EMAIL_VERIFICATION = None
    ...
    # “mandatory” blocks user to loggin
...
ACCOUNT_FORMS ={
    ...
    'login': 'authentication.forms.CustomAuthForm'
...
SOCIALACCOUNT_FORMS = {
    ...
    'signup': 'authentication.forms.CustomAuthSocialForm',
}
