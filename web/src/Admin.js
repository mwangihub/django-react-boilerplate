...
// Assume that Admin has other routes
const Admin = ({ is_authenticated, userEmail, userAdmin, userFName, userLName }) => {
    const profileNames = userFName === "null" || userLName === "null";
    return (
        <section className="container">
            <div className="nav-scroller bg-body shadow-sm">
                <nav className="nav nav-underline" aria-label="Secondary navigation">
                    <a className="nav-link active" aria-current="page" href=".">Administrator</a>
                    <a className="nav-link" href=".">
                        User requests
                        <span className="badge bg-primary ms-1 rounded-pill align-text-bottom">27</span>
                    </a>
                    {profileNames && 
            ...
            <div className="my-3 p-3 bg-body rounded shadow-sm">
                ...
                <small className="d-block text-end mt-3">
                    <a className="text-decoration-none fw-bold" href="/">All updates</a>
                </small>
            </div>
        </section>
    )
